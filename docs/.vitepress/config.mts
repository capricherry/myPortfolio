  ...
  head: [
    [
      'link',
      {
        rel: 'stylesheet',
        href:
          'https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;600;700;900&family=Roboto:wght@400;500;600;700&family=Nunito:wght@400;500;600;700&display=swap'
      }
    ]
  ]
})
